...
Example of contents of continuing education:

  \begin{itemize}
  \item New programming languages, perhaps with different
    characteristics from the ones currently used (functional, lazy
    evaluation, generic functions, prototype-based
    object-orientation, etc).
  \item New tools (editors, integrated development environments, etc).
  \item Compiler technology.
  \item Computer architecture.
  \item Algorithms and data structures for modern architectures.
  \end{itemize}
