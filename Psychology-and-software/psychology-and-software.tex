...
\vfill\end{slide}
%-----------------------------------------------------------
\begin{slide}\ti{The psychology of learning}

According to the work of Carol Dweck, there are two basic personality
types:

\begin{itemize}
\item Perfection oriented, and
\item Performance oriented.
\end{itemize}

\vfill\end{slide}
%-----------------------------------------------------------
\begin{slide}\ti{Perfection oriented}
...
\vfill\end{slide}
%-----------------------------------------------------------
\begin{slide}\ti{Performance oriented}

  \begin{itemize}
  \item Needs to perform at all times.
